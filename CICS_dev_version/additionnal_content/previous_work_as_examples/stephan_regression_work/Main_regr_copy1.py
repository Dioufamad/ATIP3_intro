...
# from Featureselection import feat_select
# from Stratify import stratify
# from random import shuffle
#
# cv_standard = 5  # K-fold cross-validation
# num_cores = 39  # Number of cores used
#
# basedir = os.getcwd()
#
...
#
# 	for drug in drugs: # loop in the drugs (numbers here) and define each time a specific_cancer-drug_response dataframe (drugframe) by restricting to only actual considered ctype's and drug used
