...
#SBATCH --job-name=p63svmlk10s10x ## job name
#SBATCH -n10
...
#SBATCH -o ./outputs/p63svmlk10s10x.%j.logo ## filename for standard output
#SBATCH -e ./outputs/p63svmlk10s10x.%j.loge ## filename for error output
...
python SL_prod_offshore_4.py -t "p63svmlk10s10x" -xproc 10 -sl "Classif" -ca "SVM_Mark1Vpar" -cs "Both" -cla_msn 30 -cla_seeds 10 -cla_profiles_path "PDX__data/processedDataBis/pData.63"  ## python command line
