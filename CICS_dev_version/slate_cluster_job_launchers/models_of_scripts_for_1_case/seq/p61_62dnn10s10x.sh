...
#SBATCH --job-name=p61_62dnn10s10x ## job name
#SBATCH -n100
...
#SBATCH -o ./outputs/p61_62dnn10s10x.%j.logo ## filename for standard output
#SBATCH -e ./outputs/p61_62dnn10s10x.%j.loge ## filename for error output
...
python SL_prod_offshore_4.py -t "p61_62dnn10s10x" -xproc 100 -sl "Classif" -ca "DNN_Mark2Vseq" -cs "Both" -cla_msn 30 -cla_seeds 10 -cla_profiles_path "PDX__data/processedDataBis/pData.61.62"  ## python command line
